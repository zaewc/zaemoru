...
import { toZaemoruAttributes, zaemoruComponentTags } from "@zaemoru/elements";
import type { ZaemoruAdapterProps, ZaemoruComponentName } from "@zaemoru/elements";
...
export const ZaemoruLitComponents = zaemoruComponentTags;

export function createZaemoruLitAttrs(name: ZaemoruComponentName, props: ZaemoruAdapterProps = {}) {
