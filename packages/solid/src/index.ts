...
export const ZaemoruSolidComponents = zaemoruComponentTags;

export function createZaemoruSolidProps(
...
export function resolveZaemoruSolidComponent(name: ZaemoruComponentName) {
  return zaemoruComponentTags[name];
}

export const zaemoruSolid = {
  customElementPrefix: "zm-",
  components: ZaemoruSolidComponents,
};
