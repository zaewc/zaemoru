...
export const ZaemoruPreactComponents = zaemoruComponentTags;

export function createZaemoruPreactProps(
...
export function resolveZaemoruPreactComponent(name: ZaemoruComponentName) {
  return zaemoruComponentTags[name];
}

export const zaemoruPreact = {
  customElementPrefix: "zm-",
  components: ZaemoruPreactComponents,
};
