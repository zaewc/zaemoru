...
export const ZaemoruVueComponents = zaemoruComponentTags;
  ...
  return {
    install(app: VueLikeApp) {
      ...
      app.config.globalProperties = {
        ...app.config.globalProperties,
        $zaemoru: ZaemoruVueComponents,
      };
    },
  };
}

export function resolveZaemoruVueComponent(name: ZaemoruComponentName) {
  return zaemoruComponentTags[name];
}

export function createZaemoruVueAttrs(name: ZaemoruComponentName, props: ZaemoruAdapterProps) {
