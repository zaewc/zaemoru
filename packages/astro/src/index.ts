...
export const ZaemoruAstroComponents = zaemoruComponentTags;

export function createZaemoruAstroAttrs(
...
export function resolveZaemoruAstroComponent(name: ZaemoruComponentName) {
  return zaemoruComponentTags[name];
}

export const zaemoruAstro = {
  name: "@zaemoru/astro",
  components: ZaemoruAstroComponents,
};
