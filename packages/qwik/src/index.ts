...
export const ZaemoruQwikComponents = zaemoruComponentTags;

export function createZaemoruQwikProps(
...
export function resolveZaemoruQwikComponent(name: ZaemoruComponentName) {
...
export const zaemoruQwik = {
  ...
  clientOnly: true,
  components: ZaemoruQwikComponents,
};
